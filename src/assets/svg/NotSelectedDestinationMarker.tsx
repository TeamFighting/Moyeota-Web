...
const SvgNotSelectedDestinationMarker = (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 98 101" {...props}>
        <g filter="url(#NotSelectedDestinationMarker_svg__a)">
            <path
                fill="#1EDD81"
                fillRule="evenodd"
        ...
        <defs>
            <filter
                id="NotSelectedDestinationMarker_svg__a"
                width={106}
                height={106}
                x={-4}
                y={0}
...
export default SvgNotSelectedDestinationMarker;
